        ...
        <div class="container" style="padding-top: 124px;z-index: 0;">
            <div class="row d-flex justify-content-center justify-content-lg-start">
                ...
                <div class="col-md-6 d-flex flex-column">
                    ...
                    <div class="d-flex flex-row"><input class="form-control justify-content-sm-center" type="text" id="profile-tagline" style="font-size: 24px;background: rgba(255,255,255,0);border-radius: 8px;" name="tagline" placeholder="Tagline"><i class="far fa-star"></i></div>
                </div>
            </div>
        </div>
    </section>
